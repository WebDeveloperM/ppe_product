...
FACE_ID_LIVE_BURST_MIN_FRAMES = int(os.environ.get('FACE_ID_LIVE_BURST_MIN_FRAMES', '12'))
FACE_ID_BLINK_SCORE_DROP_THRESHOLD = float(os.environ.get('FACE_ID_BLINK_SCORE_DROP_THRESHOLD', '6.0'))
