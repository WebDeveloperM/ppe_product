...
FACE_ID_LIVE_CHALLENGE_TURN_THRESHOLD = float(os.environ.get('FACE_ID_LIVE_CHALLENGE_TURN_THRESHOLD', '0.03'))
FACE_ID_LIVE_CHALLENGE_POSITION_THRESHOLD = float(os.environ.get('FACE_ID_LIVE_CHALLENGE_POSITION_THRESHOLD', '4.0'))
