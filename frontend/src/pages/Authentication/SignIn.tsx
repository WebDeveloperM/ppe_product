...
const SignIn: React.FC = () => {
  ...
  const getBnpzIdRedirectUri = () => `${window.location.origin}/auth/signin`;
  ...
  const startBnpzIdLogin = () => {
    ...
    authorizeUrl.searchParams.set('client_id', 'tb-project');
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50 px-4">
          <div className="w-full md:w-1/2 rounded-lg bg-white p-4 shadow-xl dark:bg-boxdark">
            ...
            <p className="mb-3 text-sm text-slate-600 dark:text-slate-300">
              Нажмите кнопку один раз. Система автоматически снимет несколько кадров подряд и отклонит слишком статичное изображение с экрана телефона.
            </p>
